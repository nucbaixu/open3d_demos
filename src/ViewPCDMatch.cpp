...
int main(int argc, char* argv[]) {
    ...
    constexpr int NUM_OF_COLOR_PALETTE = 5;
    ...
    int verbose = utility::GetProgramOptionAsInt(argc
        , argv
        , "--verbose", 5);
